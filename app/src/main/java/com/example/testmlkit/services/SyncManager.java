package com.example.testmlkit.services;

import static com.example.testmlkit.Constants.LD_CATALOG;
import static com.example.testmlkit.Constants.LD_TIMESTAMP;
import static com.example.testmlkit.Constants.PACKAGE_NAME;
import static com.example.testmlkit.Constants.T_SERVER_TIMEOUT;
...
import com.example.testmlkit.MainActivity;
import com.example.testmlkit.R;
import com.example.testmlkit.Utils;
...
import com.example.testmlkit.utils.UrlFactory;
...
public class SyncManager extends IntentService {
    ...
    private void showNotification(int newCount) {
        ...
        PendingIntent startPending = PendingIntent.getActivity(this, 0, startIntent, PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE);
