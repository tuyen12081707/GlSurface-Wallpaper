...
import static com.example.testmlkit.Constants.SERVICE_NAME;
...
import com.example.testmlkit.wallpaper.GLWallpaperPreview;
...
public class SetActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.set_menu_set) {
            // Set wallpaper
            setWallpaper();
            return true;
        } else if (id == R.id.set_menu_settings) {
            // Start settings
            Intent intent = new Intent(context, SettingsActivity.class);
            startActivity(intent);
            return true;
        } else if (id == R.id.set_menu_delete) {
            // Delete local content
            deleteWallpaper();
            return true;
        } else if (id == R.id.set_menu_link) {
